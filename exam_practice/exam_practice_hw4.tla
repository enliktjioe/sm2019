...
\* comment this code to make the error-trace activated in the model
\* please uncomment
      account_locked := FALSE;
      ghost_debt := 0;
  end either;
...
\* Last modified Sun Jan 12 12:24:55 EET 2020 by enlik
\* Created Sun Jan 12 12:00:13 EET 2020 by enlik
